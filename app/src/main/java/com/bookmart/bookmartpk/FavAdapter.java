...
public class FavAdapter extends FirestoreRecyclerAdapter<FavBook, FavAdapter.ViewHolder> {
    private OnItemClickListerner listerner;

    private Context context;


    private FirestoreRecyclerOptions<FavBook> mUploads;

    public FavAdapter(@NonNull FirestoreRecyclerOptions<FavBook> options) {
        super(options);
        mUploads = options;
    }

    @Override
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position, @NonNull FavBook model) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView pdf;
        Button read;
        private String BOOKImage, BOOKPdf, BookName;
        String Pages;
        ...
        public ViewHolder(@NonNull final View ditemView) {
            ...
            imageViewFavorite.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent1 = new Intent(ditemView.getContext(), Favorites.class);
                    ditemView.getContext().startActivity(intent1);
